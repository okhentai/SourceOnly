...
#include "UEStarRail/Character/StarRailAnimInstance.h"
#include "UEStarRail/Weapon/Projectile.h"
#include "UEStarRail/Weapon/Shotgun.h"
...
void UCombatComponent::SetHUDCrosshairs(float DeltaTime)
{
	...
	if (Controller)
	{
		HUD = HUD == nullptr ? Cast<AStarRailHUD>(Controller->GetHUD()) : HUD;
		if (HUD)
		{
			if (EquippedWeapon)
			{
